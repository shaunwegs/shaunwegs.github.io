...
"c", "c", "a" ],
	[
"What course comes next in this CTE pathway?",
"Computer Science II",
...
"c", "c", "c" ],
	[
"What was the water integrator?",
"an early analog computer built in the Soviet Union in 1936 by Vladimir Sergeevich Lukyanov",
"a programming language designed for engineering purposes by Konrad Zuse between 1942 and 1945",
"A sophisticated electronic computer that used perhaps 1,800 thermionic valves, proposed by Tommy Flowers",
"an electro-mechanical device used to help decipher German secret messages, produced in 1939 at the UK Government Code and Cypher School (GC&CS) at Bletchley Park by Alan Turing",
"a special-purpose machine designed around October 1938 by Polish Cipher Bureau cryptologist Marian Rejewski, which the Bombe was based on.",
"d", "d", "a" ],
	[
"What did Vladimir Sergeevich Lukyanov build?",
...
"d", "d", "a" ],
	[
"What did Shigetaka Kurita invent in 1999?",
"the Emoji",
"the Apple computer",
"the Xbox",
"the Internet",
...
"d", "d", "a" ],
	[
"In 1938, during the Cold War, a soviet system code-named Oko",
"malfunctioned and misreported that an intercontinental ballistic missiles had been fired at the USSR",
"was completed, giving the USSR an advantage in the war",
"malfunctioned and caused a nuclear meltdown",
"provided early detection of an incoming attack that would have decimated soviet military bases",
"allowed soviet operatives to intercept and decrypt top secret US military communications",
"d", "d", "a" ],
	[
...
"Ada, by Jean Ichbiah",
"Fortran, by John Backus",
"Cobol, by Grace Hopper",
"d", "d", "a" ],
	[
"Who create the programming language Plankalkul?",
"Konrad Zuse",
"Yukihiro Matsumoto",
"Jean Ichbiah",
"John Backus",
...
"d", "d", "a" ],
	[
"According to the TIOBE index, what's the most popular programming language?",
"Python",
"C",
"C++",
"C#",
...
"e", "e", "a" ],
	[
"In the future, we'll be able to check a patient's sample against a whole _________ of viruses",
"database",
"repository",
...
"e", "e", "a" ],
	[
"Forecasting weather requires too many calculations for a human, we use a _________ to forecast it.",
"database",
"repository",
"programming language",
"computer model",
...
"e", "e", "d" ],
	[
"What's the predominant programming language used in the Unity game engine?",
"Python",
"C",
"C++",
"C#",
...
"e", "e", "d" ],
	[
"What certification should you be able to earn in this course?",
"Python",
"C",
"C++",
"C#",
...
"a", "a", "a" ],
	[
"the 'third' industrial revolution was due to?",
"computers",
"ai",
"the telegraph",
...
"d", "d", "a" ],
	[
"the 'second' industrial revolution was due to?",
"computers",
"ai",
"the internet",
"robotics",
...
"d", "d", "d" ],
	[
"the 'first' industrial revolution was due to?",
"computers",
"ai",
"the internet",
"the telegraph",
...
"made steel easier and affordable",
"made iron equally useful to steel",
"made the production of microchips possible",
"resulted in the developement of the telegraph",
"d", "d", "b" ],
	[
"What is the differentiating factor between an industrial revolution and just new tech?",
"creating new business and jobs across all industries",
"entirely revolutionizing a specific area of culture or society",
"allowing a country or regions to rapidly increase in wealth",
"new technology which results in the development of many other new technologies",
"technology which allows all peoples to wealthier and happier",
"d", "d", "a" ],
	[
"Which of the following was NOT a skill that Neha Agrawal recommended related to Engineering?",
...
"d", "d", "a" ],
	[
"Which of the following is most comparable to computer science?",
"screwdriver",
"screw",
"block of wood",
"the user holding the screwdriver",
"a clamp to secure the wood",
"e", "e", "a" ],
	[
"Which of the following is the best description of computer science?",
...
"e", "e", "a" ],
	[
"Efficiency in medical research can be rapidly improved through",
"programming and automated image analysis",
"more powerful microscopes",
"faster and more powerful computer chips",
"additional openings in medical schools",
"access to both apple and windows computers",
"e", "e", "a" ],
	[
"In upcoming years, the job market for Information Security Analysts is expected to",
"stay the same",
"decrease, with pay around $100,000",
"increase, with pay around $100,000",
"decrease, with pay around $60,000",
"be nearly replaced by AI and Automation",
"b", "b", "c" ],
	[
"GitHub is used to",
...
"d", "d", "d" ],
	[
"What is a hackathon?",
"a short event over a few days where people create a tech-related project",
"a month long event where people create a tech-related project",
"a series of multiple classes crammed into a few days to teach the basics of cybersecurity",
"a professional conference focused on new developments in hacking and reverse engineering",
"none of the above",
"d", "d", "a" ],
	[
"What is a game jam?",
"a short event over a few days or months where people create a game",
"a year long event where people create a game",
"a series of multiple classes crammed into a few days to teach the basics of game design",
"a professional conference focused on game design and development",
"none of the above",
"d", "d", "a" ],
	[
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>CS August Quiz</h1><h2>Year 2<BR>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  var ques = 20;
  $_("test_status").innerHTML = "<h1>CS August Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
