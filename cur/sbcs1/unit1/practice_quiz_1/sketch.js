test2.innerHTML = "<center><br><I><font size='-1' color='#dddddd'>Correct answer will be displayed here after answering. </font></I><br><br>Read the questions and answers carefully. <br>Some questions and answers look similar to others, but the details may differ.</center>"
...
var questions = [
    ...
    ['See the image below for both the starting state and the intended ending state.<br><br><center><img src="01.png" width="95%"></center><br><br>What would be the result of the following code snippet?<blockquote><i>move()<br>put_ball(<br>turn_left()<br>move()<br>move()</i></blockquote>',
    "The code will result in the desired goal state",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too far",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too few",
    "Logic Error: The code will execute successfully, but Karel will have placed the ball on the wrong space",
    "Syntax Error: The code will crash during execution due to an error in the code",
    "d", "b", "e", "90" ],
    
    ['See the image below for both the starting state and the intended ending state.<br><br><center><img src="01.png" width="95%"></center><br><br>What would be the result of the following code snippet?<blockquote><i>move()<br>turn_left()<br>move()<br>put_ball()<br>move()</i></blockquote>',
    "The code will result in the desired goal state",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too far",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too few",
    "Logic Error: The code will execute successfully, but Karel will have placed the ball on the wrong space",
    ...
    ['See the image below for both the starting state and the intended ending state.<br><br><center><img src="01.png" width="95%"></center><br><br>What would be the result of the following code snippet?<blockquote><i>move()<br>put_ball()<br>turn_left()<br>move()</i></blockquote>',
    "The code will result in the desired goal state",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too far",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too few",
    "Logic Error: The code will execute successfully, but Karel will have placed the ball on the wrong space",
    ...
    ['See the image below for both the starting state and the intended ending state.<br><br><center><img src="01.png" width="95%"></center><br><br>What would be the result of the following code snippet?<blockquote><i>move()<br>put_ball()<br>turn_left()<br>move()<br>move()<br>move()</i></blockquote>',
    "The code will result in the desired goal state",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too far",
    "Logic Error: The code will execute successfully, but Karel will have moved one space too few",
    "Logic Error: The code will execute successfully, but Karel will have placed the ball on the wrong space",
    ...
    "A syntax error is when your program won't run because of an error; a logic error is when your program runs, but it doesn't do what you intended",
    "A logic error is when your program won't run because of an error; a syntax error is when your program runs, but it doesn't do what you intended",
    "Both a syntax error and a logic error is when your program won't run because of an error",
    "Both a syntax error and a logic error is when your program runs, but it doesn't do what you intended",
    "none of these are true",
    "b", "a", "a", "90" ],
    
    ["The course is part of a CTE pathway that's continued at the Guthrie. Which is it?",
    ...
    "independent development endpoint",
    "integrated development environment",
    "integrated data endpoint",
    "immersive development endpoint",
    "b", "a", "c", "90" ],
    
    ["When the name of the function is multiple words in length, what is the name of the standard convention we use in Python?",
    "macro case",
    "kebab case",
    "snake case",
    "camel case",
    ...
    ["When the name of the function is multiple words in length, in Python we use Snake Case. What special character does this involve?",
    "addition symbol",
    "hyphen",
    "underscore",
    "at symbol",
  ...
  ["Which of these is the correct way to call the move function?",
    "call.func(move)",
    "function(move)",
    "move()",
    "(move)",
  ...
  ["An exhaustive record of your skills and experiences is a...",
    "Function",
    "Algorithm",
    "CV",
    "Portfolio",
  ...
  ["Which of the follow is true?",
    "Portfolios briefly describe why you're a good applicant and Resumes show them why you're a good applicant",
    "Both Portfolios and resumes briefly describe why you're a good applicant",
    "Resumes briefly describe why you're a good applicant and portfolios show them why you're a good applicant",
    "Both portfolios and resumes show them why you're a good applicant",
    "None of these are true",
    "d", "a", "c", "90" ],

  ["A line of code that reads 'move()' is an example of' is an example of",
    "CPython",
  ...
  ["A line of code that reads '1110100 01011101 00010110 00101111' is an example of",
    "CPython",
    "a function",
    "high abstraction",
    "low abstraction",
  ...
  ["If we wanted Karel to build a bunch of towers, we could abstract our code by creating a build_tower()",
    "CPython",
    "a top down design",
    "an integer",
    "function",
  ...
  ["Teaching Karel to turn right, instead of writing turn_left() 3 times over and over again is an example of",
    "CPython",
    "a top down design",
    "an integer",
    "abstraction",
    ...
    ["What is the file extension for a Python file?",
      ...
      ["Which of the following files would be a python file?",
        ...
        ["Python is named after...",
          "The Monty Python, a British comedy group",
          "Python, or Pytho, of the Greek Mythos; a giant serpent living at the center of the world",
          "Guido van Rossum's pet cat, nicknamed Python because it would slide around on its stomach when it was a kitten",
          "The family of non-venomous snakes, Pythonidae (aka pythons), because Guido van Rossum had a pet python while attending university",
          "Python of Catana, a poet who served Alexander the Great",
          "a", "a", "a", "90" ],
          ...
          ["Who is the creator of Python?",
            ...
            "a", "a", "c", "90" ],
              ...
              ["Which of these is default implementation of the Python programming language?",
                "IDE",
                "IDLE",
                "CPython",
                "PyCharm",
              ...
              ["Python is...",
                ...
                "the language most commonly used to build websites",
                "a great language for building modern games with high quality graphics on game consoles",
                "a compiled language",
                "a low-level language",
                "a", "a", "a", "90" ],

                ["Python is...",
                  "a good choice for creating and executing tests for applications",
              ...
              ["What is CPython?",
                ...
                "the compiled language used to perform high-level programming functions",
                "a compiler that converts Python into machine code specifically to run on IoT devices",
                "a library used for generating C code from Python",
                "a", "c", "b", "90" ],

            ["What is the definition of source code?",
              "a set of instructions to produce a desired result, but not specifically for a computer",
              "instructions written in code for a computer to specifically do something",
              "sets of commands designed so that we can write specific instructions",
              "instructions written in a high level language for a computer to specifically do something",
              "the file that contains instructions written in a high level language for a computer to specifically do something",
              "b", "a", "d", "90" ],

                ["A text file that contains instructions which make up a program Python (or other similar languages) could be called a...",
                  "source code",
                  "an ide",
                  "a debugger",
                  "an interpreter",
                ...
                ["Which of the following elements are needed to make a language?",
                  "Phonology, phonetics, syntax, and a lexicon",
                  "Phonology, phonetics, syntax, and semantics",
                  "An alphabet, a lexis, a lexicon, syntax, and semantics",
                  "An alphabet, a lexicon, syntax, and phonetics",
                  "An alphabet, a lexis, syntax, and semantics",
                  "b", "c", "e", "90" ],

                ["Machine code is...",
                  "a low-level programming language specifically used for programming robots",
                  "a low-level language that is easy to learn that was popular in the 90's before Python",
                  "a high-level language that is run directly by the processor without translation or compilation",
                  "a high-level computer programming language that is interpretted line by line",
                  "a low-level computer programming language consisting of binary or hexadecimal instructions the a cpu can process directly",
                  "b", "a", "e", "90" ],

                ["CPython, the default reference implementation of Python is written...?",
                  "the R language",
              ...
              ["What is the definition of source file?",
                "a set of instructions to produce a desired result, but not specifically for a computer",
                "instructions written in code for a computer to specifically do something",
                "sets of commands designed so that we can write specific instructions",
                "instructions written in a high level language for a computer to specifically do something",
                ...
                ["What is the definition of an instruction list?",
                  "a set of instructions to produce a desired result, but not specifically for a computer",
                  "instructions written in code for a computer to specifically do something",
                  "sets of commands designed so that we can write specific instructions",
                  "instructions written in a high level language for a computer to specifically do something",
                  ...
                  ["Which term matches the following definition?<blockquote><i>sets of commands designed so that we can write specific instructions</i></blockquote>",
                    "an instruction list",
                    "a program",
                    "algorithm",
                    "source code",
                    ...
                    ["Which of following is an artifical language?",
                      "italian",
                      "portuguese",
                      "korean",
                      "c++",
                    ...
                    ["Which of following is an artifical language?",
                      ...
                      ["Which of following is a natural language?",
                        "japanese",
                        "java",
                        "javascript",
                        "python",
                  ...
                  ["Which term matches the following definition?<blockquote><i>instructions written in a high level language for a computer to specifically do something</i></blockquote>",
                    "an instruction list",
                    "a program",
                    "algorithm",
                    "source code",
                  ...
                  ["Which term matches the following definition?<blockquote><i>the file that contains instructions written in a high level language for a computer to specifically do something</i></blockquote>",
                    "an instruction list",
                    "a program",
                    "algorithm",
                    "source code",
                    ...
                    ["Which term matches the following definition?<blockquote><i>the totality of words within a language</i></blockquote>",
                      "an instruction list",
                      "lexicon",
                      "semantics",
                      "syntax",
                      ...
                      ["Which term matches the following definition?<blockquote><i>a set of meaningful words in a specific language, which could be a natural or artificial language</i></blockquote>",
                        ...
                        ["Which term matches the following definition?<blockquote><i>the rules used to arrange words in a meaningful way</i></blockquote>",
                          "an instruction list",
                          "lexicon",
                          "semantics",
                          "syntax",
        ...
        ["Which version of Python are we using (this is also the most popular version)?",
          "4",
          "0",
          "1",
          "3",
          ...
          ["Which of the following will let us write a comment in python?",
            "// comment",
            "# comment",
            "*** comment ***",
            "(comment)",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>Python Unit 1 Practice</h1><h2>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  $_("test_status").innerHTML = "<h1>Python Unit 1 Practice</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
