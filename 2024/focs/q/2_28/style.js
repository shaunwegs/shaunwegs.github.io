...
vs++;
localStorage.setItem("focs_feb_on_load_counter", vs);
...
[
		...
		[
			...
			[
				...
				[
					...
					[
						"In the color code #ae0691, which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
	...
	[
						"In the color code #720691, which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
						...
						"c", "c", "c" ],
	[
						"In the color code #99b091, which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
					...
					[
						"In the color code (174, 6, 145), which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
	...
	[
						"In the color code (114, 6, 145), which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
						...
						"c", "c", "c" ],
	[
						"In the color code (153, 176, 145), which of the primary colors has the highest value?",
						"white",
						"yellow",
						"blue",
						"green",
				...
				[
					...
					[
						...
						[
							...
							[
							"What is the hexadecimal value for (255, 255, 255)?",
							"#F0F0F0",
							"#0F0F0F",
							"#FF0000",
							"#000000",
							...
							"e", "e", "e" ],
							[
							"What is the hexadecimal value for (0, 0, 0)?",
							"#F0F0F0",
							"#0F0F0F",
							"#FF0000",
							"#000000",
							...
							"d", "d", "d" ],
							[
							"What is the hexadecimal value for (255, 0, 0)?",
							"#0000FF",
							"#00FF00",
							"#FF0000",
							"#FFFF00",
							...
							"c", "c", "c" ],
							[
							"What is the hexadecimal value for (0, 0, 255)?",
							"#F0000F",
							"#000F00",
							"#FF0000",
							"#00000F",
							...
							"e", "e", "e" ],
							[
							"What is the hexadecimal value for (0, 255, 0)?",
							"#0000FF",
							"#00FF00",
							"#FF0000",
							"#FFFF00",
							...
							"b", "b", "b" ],
							[
							"What is the hexadecimal value for (255, 255, 0)?",
							"#0000FF",
							"#00FF00",
							"#FF0000",
							"#FFFF00",
							...
							"d", "d", "d" ],
							[
							"What is the hexadecimal value for (0, 255, 255)?",
							"#0000FF",
							"#00FF00",
							"#FF0000",
							"#FFFF00",
							...
							"e", "e", "e" ],
							[
							"What is the hexadecimal value for (255, 0, 255)?",
							"#FF00FF",
							"#00FF00",
							"#FF0000",
							"#FFFF00",
							...
							[
							"The highest value for a pair of digits in a hexadecimal code is",
							"FF",
							"F0",
							"100",
							"16",
							...
							[
							"The highest value for a color in an RGB code is",
							"255",
							"250",
							"100",
							"FF",
...
[
							...
							"a", "a", "a" ],
							[
							"What is the RGB value for green?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 0, 255)",
							...
							"d", "d", "d" ],
							[
							"What is the RGB value for cyan?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 255, 0)",
...
[
							"What is the equivalent RGB color code for #FFFFFF?",
							"(100, 100, 100)",
							"(99, 99, 99)",
							"(FF, FF, FF)",
							"(00, 00, 00)",
							...
							"e", "e", "e" ],
							[
							"What is the equivalent RGB color code for #000000?",
							"(100, 100, 100)",
							"(a, a, a)",
							"(FF, FF, FF)",
							"(0, 0, 0)",
							...
							"d", "d", "d" ],
							[
							"What is the equivalent RGB color code for #FF0000?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(0, 100, 0)",
							...
							"c", "c", "c" ],
							[
							"What is the equivalent RGB color code for #0000FF?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(0, 100, 0)",
							...
							"a", "a", "a" ],
							[
							"What is the equivalent RGB color code for #00FF00?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 0, 255)",
							...
							"b", "b", "b" ],
							[
							"What is the equivalent RGB color code for #FFFF00?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 255, 0)",
							...
							"d", "d", "d" ],
							[
							"What is the equivalent RGB color code for #00FFFF?",
							"(0, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 255, 0)",
							...
							"e", "e", "e" ],
							[
							"What is the equivalent RGB color code for #FF00FF?",
							"(255, 0, 255)",
							"(0, 255, 0)",
							"(255, 0, 0)",
							"(255, 255, 0)",
...
function renderResults(){
  ...
  render2.innerHTML += "<br><h3>Attempt #"+vs +" for " + userFirstName +" "+ userLastName +"<br>for FOCS: RGB & Hexadecimal Quiz.<br>Screenshot & upload your results!</h3><br><br><h1>Categories</h1>"
...
function renderQuestion() {
  var test = $_("test");
  var ques = 25;
  $_("test_status").innerHTML = "<h1>Fundamentals of CS, Q3 - Colors+ Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
