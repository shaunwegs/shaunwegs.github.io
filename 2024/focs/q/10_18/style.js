						...
						[
							...
							[
								...
								[
									...
									"Start the list with an &#60;ol> tag.<br> Use an &#60;li> tag for each item.<br> Close the list element with an &#60;/ol> tag.",
									"Start the list with an &#60;ul> tag.<br> Use an &#60;li> tag for each item.<br> Close the list element with an &#60;/ul> tag.",
									"Start the list with a &#60;list> tag.<br> Use an &#60;ol> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"Start the list with a &#60;list> tag.<br> Use an &#60;ul> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"Start the list with a &#60;list style='ordered'> tag.<br> Use an &#60;ul> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"a", "a", "a" ],
									[
									...
									"Start the list with a &#60;list> tag.<br> Use an &#60;ol> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"Start the list with a &#60;list> tag.<br> Use an &#60;ul> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"Start the list with a &#60;list style='unordered'> tag.<br> Use an &#60;ul> tag for each item.<br> Close the list element with a &#60;/list> tag.",
									"b", "b", "b" ],
									[
