...
var vs = localStorage.getItem('focsp_on_load_counter');
var userFirstName = localStorage.getItem('focsp_userFirstName');
var userLastName = localStorage.getItem('focsp_userLastName');
...
[
	...
	[
		...
		[
						...
						"b", "b", "b" ],
	[
"What type of software would you typically create a website with?",
"Browser",
"IDE or Code Editor",
"Search Engine",
"Word Processor",
...
"b", "b", "b" ],
		[
"What type of software connects you to a website?",
"Browser",
"IDE or Code Editor",
"Search Engine",
"Word Processor",
...
"a", "a", "a" ],
	...
	[
"Which of the following is an example of an IDE/Code Editor?",
"Firefox",
"VSCode",
"Powerpoint",
"Google Docs",
...
"Chrome",
"Safari",
"Trick Question, all of these are browsers",
"a", "a", "a" ],
	[
"Which of the following is is a browser made by Google?",
"VSCode",
"Firefox",
"Chrome",
"Safari",
...
"c", "c", "c" ],
	[
"The modern way to stylize a website uses which computer language?",
"Javascript",
"CSS",
"HTML",
"Rust",
...
"b", "b", "b" ],
	...
	[
"HTML Tags are contained within which type of symbols?",
"angle brackets",
"square brackets",
"curly braces",
"semicolons",
...
"a", "a", "a" ],
	...
	[
"What is a boolean?",
"a value that can change while the program runs",
"a value that is only either true or false",
"a value that is always only a number",
"a value that contains text",
"a value that can not change while the program runs",
"b", "b", "b" ],
	[
"What is a variable?",
"a value that can change while the program runs",
...
"a", "a", "a" ],
	[
"What type of computer language is Snap?",
...
"a", "a", "a" ],
	[
"What type of computer language is JS?",
...
"a", "a", "a" ],
[
"What type of computer language is HTML?",
"Programming Language",
"Styling Language",
"Markup Language",
"Assembly Language",
...
"c", "c", "c" ],	
[
"What type of computer language is CSS?",
"Programming Language",
"Styling Language",
"Markup Language",
"Assembly Language",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>Fund. of CS, Winter Practice Final</h1><h2>Attempt #" +vs;
  $_('timeleft').innerHTML = '</h2>'; l1 = 25 - cor;
  test.innerHTML = "";
  test.innerHTML += "<h1>Results for " + userFirstName + "</h1><h3>Fund. of CS, Winter Practice Final<br>Attempt #"+vs +" for " + userFirstName +" "+ userLastName +".<br>Screenshot & upload your results!</h3>";
...
function renderQuestion() {
  ...
  $_("test_status").innerHTML = "<h1>Fund. of CS: Winter Practice Final</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
