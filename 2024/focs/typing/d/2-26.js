...
let quotes_array = [
  "RGB & hexadecimal are the same",
  "color system, we just represent",
  "the values differently.",
  "The primary colors in both",
  "are Red, Green, Blue, and they're",
  "even in the same order.",
  "Yellow in RGB is full red and full green.",
  "Yellow in hexadecimal is also",
  "full red and full green.", 
  "In RGB, we represent this as",
  "(255, 255, 0)",
  "This is a base 10 system, where each",
