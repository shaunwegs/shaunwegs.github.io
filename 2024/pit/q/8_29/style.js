...
var vs = localStorage.getItem('pit2_on_load_counter');
var userFirstName = localStorage.getItem('pit2_userFirstName');
var userLastName = localStorage.getItem('pit2_userLastName');
...
[
				...
				[
					...
					[
						...
						[
								...
								[
									"Our keyboard is best aligned to which standard? ",
									"ANSI",
									"ISO",
									"JIS",
									"OSHA",
	...
	[
								...
								[
									"Related to safety standards and organizations, we can think of ANSI as the ",
									"facilitator",
									"enforcer",
									"developer",
									"supporter",
									...
									"a", "a", "a" ],
									[
										"Related to safety standards and organizations, we can think of ASME as the ",
										"facilitator",
										"enforcer",
										"developer",
										"supporter",
								...
								[
									...
									"a", "a", "a" ],
									[
										"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i> <br><br>in this example, what is the index.html? ",
										"protocol",
										"subdomain",
										"document",
										"top level domain",
										...
										"c", "c", "c" ],
									[
										"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i><br><br>in this example, what is the springbranchisd.com/mruu ",
										"protocol",
										"subdomain",
										"document",
										"top level domain",
										...
										"e", "e", "e" ],
									[
										"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i><br><br>in this example, what is the com? ",
										"protocol",
										"subdomain",
										"document",
										"top level domain",
										...
										"d", "d", "d" ],
									[
										"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i><br><br>in this example, what is sites? ",
										"protocol",
										"subdomain",
										"domain",
										"top level domain",
										...
										"b", "b", "b" ],
										[
											"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i><br><br>in this example, what is google? ",
											"protocol",
											"subdomain",
											"domain",
											"top level domain",
											...
											"c", "c", "c" ],
									[
										"Consider the following URL: <br> <br><i>https://sites.google.com/springbranchisd.com/mruu/index.html</i><br><br>in this example, what is the http? ",
										"protocol",
										"subdomain",
										"domain",
										"top level domain",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>PIT, August 30th Quiz</h1><h2>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  var ques = 15;
  $_("test_status").innerHTML = "<h1>PIT: August 30 Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
