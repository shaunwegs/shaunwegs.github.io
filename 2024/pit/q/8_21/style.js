...
var vs = localStorage.getItem('pit_on_load_counter');
...
vs++;
localStorage.setItem("pit_on_load_counter", vs);
...
var questions = [
	...
	[
		...
		"you get an opportunity for one retake, no conditions required",
		"you get as many retake opportunities as you'd like",
		"you have the opportunity for a retake, but it must be within 5 school days of the original task",
		"a", "a", "a" ],
		[
			"As per district policy, if you do a retake for a major grade, ",
			"the highest grade goes into Skyward",
			...
			[
				...
				"after you have served a detention, you will redo the work, with no retake allowed",
				"a panel of teachers and administrators will discuss whether or not you will recieve a zero or are allowed to redo the work",
				"you recieve a zero, and may not do a retake",
...
"a", "a", "a" ],
[
	"In this class, quizzes are part of which grading category?",
	"minor",
	"major",
	"application",
	...
	"a", "a", "a" ],
	[
		"In this class, project checkpoints are part of which grading category?",
		"minor",
		"major",
		"application",
		"they have their own special category",
	...
	[
		...
		"a", "a", "a" ],
			[
				...
				"a", "a", "a" ],
				[
					"Our official tutorial day/time is",
					"Tuesdays, 3:15 - 4:15",
					...
					"a", "a", "a" ],
	[
"In this class, what grading category is the smallest percentage of your skyward grade?",
"major",
"minor",
"mapplication",
"All grading categories are equal",
...
"b", "b", "a" ],
[
"What model of computer are we using?",
"iMac",
"MacBook",
"Optiplex",
"Latitude",
...
[
	...
	[
		...
		[
				...
				"b", "b", "a" ],
	[
		"Where should you check your grades for this course?",
		"skyward",
		"canvas",
		"gmail",
		"all of them",
...
[
	...
	[
		...
		[
			...
			"c", "c", "c" ],
			[
				"In the spring, you'll have the opportunity to take an entry-level certification for",
				"Cyber Security",
				"Photoshop",
				"Digital Literacy",
				"Programming",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>Principles of IT, August 21 Quiz</h1><h2>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  var ques = 15;
  $_("test_status").innerHTML = "<h1>Principles of IT: August 21 Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
