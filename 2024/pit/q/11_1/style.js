...
if (userFirstName === null) {
	...
	localStorage.setItem('focs1_userFirstName', userFirstName);}
...
var questions = [
				...
				[
		"What causes light to have different colors?",
		"Different angles of light.",
		"Different amplitudes of light.",
		"Different particles of light.",
		"Different wavelengths of light.",
		"Different wavelengths of light, combined with their angle.",
		"d", "d", "d" ],
		[
		...
		"c", "c", "c" ],
		[
		"A prism splits white light into light with different wavelengths. Bluer light has ___________ wavelength so bends ________. The ________ is for redder light.",
		"longer; more; opposite",
		"shorter; more; same",
		"shorter; more; opposite",
		"shorter; less; same",
		"longer; less; same",
		"c", "c", "c" ],
				[
		"This is the spectrum of a light source, showing the relative intensity of different wavelengths of light.<BR><img src='img/graph.png' width='400' /><br>How will this light source appear?",
		"With a blue tint",
		"Dim",
		"With a red tint",
		"With a cyan tint",
	...
	[
		'Below are the spectra from two LED sources. Sometimes, lights seem to be a "Warm White LED", others may seem to be a "Cool White LED". We call redder light warm, and bluer light cool. <br><img src="img/graph2.png" width="350" /> <BR>What is true of these light sources?',
		"Source 2 is warmer than source 1",
		"Source 1 is warmer than source 2",
		"Both sources are equally warm",
		"Both sources are 'cool white LEDs'",
		"Both sources are 'neutral white LEDs'",
		"a", "a", "a" ],
		[
					...
					[
						...
						[
							...
							[
								...
								"light and bright magenta",
								"d", "d", "d" ],

								[
									"A technical artist is picking colors for leaves. They have picked a pale green with a value of (100 degree, 80%, 60%) in the HSL color scheme. Now they want a darker green to add texture to the leaves.<br> <img src='img/circ2.png' width='400' /><br>Which value represents a darker green?",
									"(100 degrees, 100%, 60%)",
									"(100 degrees, 80%, 30%)",
									"(100 degrees, 80%, 80%)",
									"(100 degrees, 50%, 60%)",
									...
									"b", "b", "b" ],
									[
										"A technical artist is picking colors for sky. They have picked a deep blue with a value of (220 degree, 80%, 50%) in the HSL color scheme. Now they have decided the sky should be grayer.<br> <img src='img/circ3.png' width='400' /><br>Which value represents a grayer blue?",
										"(260 degrees, 80%, 50%)",
										"(220 degrees, 40%, 50%)",
										"(220 degrees, 100%, 50%)",
										"(220 degrees, 80%, 30%)",
...
[
	...
	[
		...
		"the vertical center of the cylinder",
		"the horizontal face of the cylinder",
		"b", "b", "b" ],
		[
			"What part of the HSL cylinder is pure red?",
			"A point on the outside of the cylinder, at the very top",
			"A point on the outside of the cylinder, halfway up.",
			"A point on the outside of the cylinder, at the bottom",
			"an entire horizontal 'face' near the top of the cylinder",
			"an entire horizontal 'face' near the bottom of the cylinder",
			"b", "b", "b" ],
		[
			"What part of the HSL cylinder has grey values?",
			"The whole of the slice taken halfway up the cylinder.",
			"A line running through the center of the cylinder, top to bottom.",
			"The center of the slice taken halfway up the cylinder.",
			"A sphere in the center of the cylinder.",
			"The whole of the slice taken from the bottom of the cylinder.",
			"b", "b", "b" ],
	[
...
function checkA(){
  ...
  if (pos < 12) { renderQuestion(); } else { renderResults(); }  // Question Count
}
