...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>CS, August 21 Quiz</h1><h2>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  var ques = 16;
  $_("test_status").innerHTML = "<h1>CS August 21 Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
