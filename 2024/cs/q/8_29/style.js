...
var vs = localStorage.getItem('cs1_on_load_counter');
...
vs++;
localStorage.setItem("cs1_on_load_counter", vs);
						...
						[
								...
								[
									...
									[
										...
										"a", "a", "a" ],
										[
											"To display text on the screen, what command do we use in Python? ",
											"print()",
											"stndOut()",
											"display()",
											"write()",
										...
										[
											"Information theory is related to... ? ",
											"how we store information",
											"all of these are related to information theory",
											"how we transform data into bits",
											"how we send information",
											"how we communicate information",
											"b", "b", "b" ],
											[
												"Pictograms, as used for communication, are typically designed ",
												"to be visually representational of what they convey",
												"to abstractly represent individual or combinations of sounds",
												"as a full sentence or thought",
												"to convey feelings and abstract ideas",
												"to represent ",
												"a", "a", "a" ],
												[
													"The first people that used abstract symbols to communicate, that we have evidence of, is",
													"prehistoric man",
													"ancient Egyptians",
													"precolumbian populations in the Americas",
													"Asian populations in Japan",
											...
											[
												...
												"its a simple way to make sure the programming environment is working",
												"it teaches you all the basics of a language in one efficient program",
												"its a universal program thats written the same way in every program",
												"it opens a connection to the net",
												"it initializes the code editor and installs all needed libraries",
												"a", "a", "a" ],
												[
													"The premise of the-well known website Rosetta Code is ",
													"to show the code for often used programs in multiple programming languages",
													"to translate code for you from one programming langauge to another",
													"its 'uncovers' the history of well-known programs",
													"it provides explanation and instruction for famous programs in English, Spanish, and many other widely spoken languages",
													"it 'translates' well known programs into archaic/old-english as a joke",
													"a", "a", "a" ],
													[
														"The premise of the-well known website Rosetta Code is ",
														"to show the code for often used programs in multiple programming languages",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>CS1, August 30 Quiz</h1><h2>Attempt #" +vs;
