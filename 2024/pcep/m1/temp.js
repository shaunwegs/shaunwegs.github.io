...
var vs = localStorage.getItem('pit_mar_on_load_counter');
...
vs++;
localStorage.setItem("pit_mar_on_load_counter", vs);
...
[
	...
	[
		...
		"Programming/Software Development & Cybersecurity",
		"Programming/Software Development only",
...
[
	...
	[
							...
							"Part of a program that runs multiple times",
							...
							[
							"If we want something to happen in a game over and over again, we can do this using... ?",
							"conditional",
							"iteration",
							"variable",
							"algorithm",
							...
							[
							"If we want something to happen in a game only if the player has already done something else first, we can do this using... ?",
							"conditional",
							"iteration",
							"variable",
							"algorithm",
							...
							[
							"The code snippet below shows what?<br><img src='img/01.png' width='200'><br>",
							"a conditional",
							"iteration",
							"a variable",
							"defining an object",
...
[
							...
							[
							"The code snippet below shows what?<br><img src='img/12.png' width='300'><br>",
							"a conditional",
							"iteration",
							"a sequence",
							"defining an object",
							...
							[
							"What will happen if this program is run?<br><img src='img/04.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							...
							[
							"What will happen if this program is run?<br><img src='img/05.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/06.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/07.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/08.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/09.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/10.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/11.png' width='800'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will be displayed on screen if this program is run?<br><img src='img/13.png' width='300'><br>",
							"0",
							"1",
							"3",
							"4",
							...
							[
							"What will be displayed on screen if this program is run?<br><img src='img/14.png' width='300'><br>",
							"2",
							"3",
							"4",
							"6",
							...
							[
							"What will happen if this program is run?<br><img src='img/15.png' width='300'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/16.png' width='300'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will happen if this program is run?<br><img src='img/18.png' width='300'><br>",
							"the game will automatically say you won",
							"the game will automatically say you lost",
							"nothing will appear to happen",
							"the game won't work due to a bug/error",
							...
							[
							"What will be displayed on screen if this program is run?<br><img src='img/19.png' width='300'><br>",
							"1",
							"11",
							"-5",
							"21",
							...
							[
							"What will be displayed on screen if this program is run?<br><img src='img/20.png' width='300'><br>",
							"2",
							"3",
							"5",
							"7",
...
function attemptid() {
  ...
  return "<br>Attempt ID: " +il.join("") + idSum() +l1 +String(totas[2]) +String(totas[0]) +String(totas[1]) +String(vs + cor);
}
...
function renderResults(){
  ...
  test.innerHTML = "";
  test.innerHTML += "<h1>Results for " + userFirstName + " for March Quiz</h1>";
  test.innerHTML += now();
  ...
  render2.innerHTML += "<br><h3>Attempt #"+vs +" for " + userFirstName +" "+ userLastName +"<br> for March Programming Quiz.</h3>"
  render2.innerHTML += now();
  render2.innerHTML += "<br>Screenshot & upload your results!<h1>Categories</h1>"
