test2.innerHTML = "<br><I><font size='-1' color='#dddddd'>Correct answer will be displayed here after answering. </font></I><br>"
...
var questions = [
  ...
  ["The value ten point fifteen times ten raised to the power of five should be written as",
    "10.15e5",
    "10.15e5.0",
    "10.15e10**5",
    "10e15.5",
    ...
    ["Which of the followinging are the two boolean values in Python",
      "true and false",
      "True and False",
      "TRUE and FALSE",
      "1 and 0",
      "Python recognizes all of these",
      "d", "a", "b", "90" ], 

    ["Which of the followinging is true in Python?",
      "You can never change the value of a variable",
      "Variable names must start with a letter or the underscore sign",
      "Variable names are not case sensitive; myVar and myvar are the same variable",
      "You can use a variable without assigning a value; python will use a default value",
      "If you assign a new value to a variable, you'll have two variables with the same name",
      "d", "b", "b", "90" ], 

    ["How would Python represent 0.0000044 in scientific notation?",
      "-6e4.4",
      "4.4e-6",
      "4.4e-6**3",
      "-4.4e6",
    ...
    ["How would Python represent 0.000000000000093 in scientific notation?",
      "-14e9.3",
      "9.3e-14",
      "9.3e14**3",
      "14e9.3",
  ...
  ["The value thirty point five times ten raised to the power of three should be written as",
    "30.5e3",
    "30.5e3.0",
    "30.5e10**3",
    "30e5.3",
  ...
  ["The print() function can output values of",
    ...
    "not more than 5 arguments",
    "just one argument",
    "only string types",
    "int and float types only",
    "d", "a", "a", "90" ],  

    ["The meaning of the kayword parameter is determined by",
      ...
      ["What will be the output if the following code snippet is run?<blockquote><i>myVar = 3 ** 3<br>myVar += 2<br><br>print(myVar)</i></blockquote>",
        ...
        ["What will be the output if the following code snippet is run?<blockquote><i>1st_name = 'John'<br>2nd_name = 'Jacob'<br>3rd_name = 'Jingleheimer'<br>4th_name = 'Schmidt'<br>print(1st_name, 1st_name, 1st_name, 1st_name, sep='*')</i></blockquote>",
          "John*John*John*John",
          "nothing will appear to print",
          "The program will throw an error",
          "John Jacob Jingleheimer Schmidt",
          "John*Jacob*Jingleheimer*Schmidt",
          "c", "b", "a", "150" ], 

          ["What will be the output if the following code snippet is run?<blockquote><i>1st_name = 'John'<br>2nd_name = 'Jacob'<br>3rd_name = 'Jingleheimer'<br>4th_name = 'Schmidt'<br>print(sep='*', 1st_name, 2nd_name, 3rd_name, 4th_name)</i></blockquote>",
            "John*John*John*John",
            "nothing will appear to print",
            "The program will throw an error",
            "John Jacob Jingleheimer Schmidt",
        ...
        ["What will be the output if the following code snippet is run?<blockquote><i>1st_name = 'John'<br>2nd_name = 'Jacob'<br>3rd_name = 'Jingleheimer'<br>4th_name = 'Schmidt'<br>print(1st_name, 2nd_name, 3rd_name, 4th_name, sep='*')</i></blockquote>",
          "John*John*John*John",
          "nothing will appear to print",
          "The program will throw an error",
          "John Jacob Jingleheimer Schmidt",
      ...
      ["What will be the output if the following code snippet is run?<blockquote><i>y = 2<br>y+= 2<br>y *= 2<br>print(Y)</i></blockquote>",
        "2 2 2",
        "nothing will appear to print",
        "8",
        "6",
      ...
      ["What will be the output if the following code snippet is run?<blockquote><i>y = 2<br>y+= 2<br>y *= 2<br>print()</i></blockquote>",
        "2 2 2",
        "nothing will appear to print",
        "8",
        "6",
    ...
    ["What will be the output if the following code snippet is run?<blockquote><i>width = height = depth = 2<br><br>print(width, height, depth, sep='x')</i></blockquote>",
      "2 2 2",
      "2x2x2",
      "widthxheightxdepth",
      "8",
    ...
    ["What will be the output if the following code snippet is run?<blockquote><i>width = height = depth = 2<br><br>print(width, height, depth)</i></blockquote>",
      "2 2 2",
      "6",
      "8",
      "width height depth",
    ...
    ["What will be the output if the following code snippet is run with the user inputs 12 & 5 respectively?<blockquote><i>input('Provide an integer')<br>input('Provide another integer')<br>x = 1<br>y = 2<br><br>z = x<br>x = y<br>y = z<br><br>print(x, y)</i></blockquote>",
      ...
      ["What will be the output if the following code snippet is run?<blockquote><i>x = 2<br>y = 4<br><br>x = x // y<br>y = y // x<br><br>print(y)</i></blockquote>",
        ".5",
        "8",
        "8.0",
        "0",
    ...
    ["What will be the output if the following code snippet is run with the user inputs 12 & 5 respectively?<blockquote><i>x = int(input())<br>y = int(input())<br><br>x = x % y<br>y = y % x<br><br>print(x + y)</i></blockquote>",
      "1",
      "2",
      "3",
      "4",
  ...
  ["What will be the output if the following code snippet is run with the user inputs 4 & 5 respectively?<blockquote><i>x = input()<br>y = input()<br>print(x + y)</i></blockquote>",
    "45",
    "44444",
    "9",
    "4545454545",
  ...
  ["What will be the output if the following code snippet is run with the user inputs 2 & 4 respectively?<blockquote><i>x = input()<br>y = int(input())<br>print(x + y)</i></blockquote>",
    "24",
    "2222",
    "6",
    "24242424",
  ...
  ["What will be the output if the following code snippet is run with the user inputs 3 & 4 respectively?<blockquote><i>x = input()<br>y = int(input())<br>print(x * y)</i></blockquote>",
    "34",
    "3333",
    "343434",
    "12",
    ...
    ["What will be the output if the following code snippet is run with the user inputs 3 & 5 respectively?<blockquote><i>x = int(input())<br>y = int(input())<br>print(x * y)</i></blockquote>",
      "35",
      "33333",
      "343434",
      "15",
      ...
      ["What will happen if the following line of code is run?<blockquote><i>inpu('What is your name?')</i></blockquote>",
        "Python will show 'What is your name?' and wait for input for the user",
        "Python will show 'What is your name?' and wait for input for the user which will be stored in a variable",
        "Python will show 'What is your name?' but then throw an error before the user has a chance to respond to the prompt",
        "Python will show 'What is your name?', wait for the user to respond, then throw an error",
        "the code will produce an error without showing anything",
        "a", "b", "e", "120" ],

      ["What will be the output if the following line of code is run?<blockquote><i>print(3 // (2 * 3))</i></blockquote>",
        "0",
        "3",
        "4.5",
        "1",
  ...
  ["What will be the output if the following line of code is run?<blockquote><i>print(5 + 3 ** 2)</i></blockquote>",
    "16",
    "14",
    "11",
    "64",
    ...
    ["What will be the output if the following line of code is run?<blockquote><i>print('5' + '4' * 3)</i></blockquote>",
      "545454",
      "5444",
      "543",
      "555444",
      ...
      ["What will be the output if the following line of code is run?<blockquote><i>print(('5' + '4') * 3)</i></blockquote>",
        ...
        ["What will be the output if the following line of code is run?<blockquote><i>print('5' * (2 + 1))</i></blockquote>",
          "555",
          "521",
          "15",
          "53",
          ...
          ["Which of the followinging variable names are illegal?",
            "true",
            "True",
            "TRUE",
            "_and",
    ...
    ["What will be the output if the following line of code is run?<blockquote><i>print(2 / 2)</i></blockquote>",
      "1",
      "1.0",
      "2",
      ".5",
      ...
      ["What will be the output if the following line of code is run?<blockquote><i>print(2 // 2)</i></blockquote>",
        ...
        ["What will be the output if the following line of code is run?<blockquote><i>print(2 / 0)</i></blockquote>",
          "0",
          "0.0",
          "2",
          ".5",
      ...
      ["What will be the output if the following line of code is run?<blockquote><i>print(2 // 0)</i></blockquote>",
        ...
        ["What will be the output if the following line of code is run?<blockquote><i>print(0 / 2)</i></blockquote>",
          "0",
          "0.0",
          "2",
          ".5",
    ...
    ["Which of the followinging characters is used to signify the modulus operator?",
      "**",
      "%",
      "//",
      "+",
      ...
      ["Which of the followinging characters is used to signify the multiplication operator?",
        "**",
        "%",
        "//",
        "+",
        ...
        ["Which of the followinging characters is used to signify the concatenation operator?",
          "**",
          "%",
          "//",
          "+",
          ...
          ["Which of the followinging characters is used to signify the addition operator?",
            "**",
            "%",
            "//",
            "+",
        ...
        ["Which of the followinging characters is used to signify the floor or int division operator?",
          "**",
          "%",
          "//",
          "/",
          ...
          ["Which of the followinging characters is used to signify the float division operator?",
            "**",
            "%",
            "//",
            "/",
            ...
            ["Which of the followinging characters is used to signify the exponent operator?",
              "**",
              "%",
              "//",
              "/",
              ...
              "the > and < operators can return an int or a float",
              "the > and < operators always return a string",
    ...
    ["The meaning of the positional parameter is determined by",
    "its sequence",
    "its name",
    "its position",
    ...
    ["What's the difference between concatenation and addition?",
      "None of these are correct",
      "same thing, just regional dialects- US uses concatenation, the EU says addition",
      "concatenation happens when you add ints or floats together; addition is for strings",
      "addition happens when you add ints or floats together; concatenation is for strings",
      "same thing, just regional dialects- EU uses concatenation, the US says addition",
      "d", "a", "d", "90" ],

    ["The most important difference between ints and floats lies in the fact that",
    "ints can be used in conditional statements and ints cant",
    "ints can be literals and floats cant",
    "they're stored different in the computer memory",
    "they can not be used simultaneously",
    "ints and floats are actually the same thing",
    "d", "a", "c", "90" ],
    ...
    ["For the regular person, how would they describe a float vs an int?",
      "both integers and floating point numbers are whole numbers",
      "integer numbers include decimals; floating point are whole numbers",
      "floating point numbers include decimals; integers are whole numbers",
      "both integers and floating point numbers include decimals",
      "none of these are correct",
      "d", "a", "c", "90" ],


      ["If the user enters the value 35, what data type will be stored in the the variable myVar?<blockquote><i>myVar = input('Give me a value')</i></blockquote>",
        "float",
        "int",
        "bool",
        "string",
      ...
      ["What data type will be returned if the following line of code is run?<blockquote><i>return(5 + 3.0)</i></blockquote>",
      "float",
      "int",
      "bool",
      "string",
      ...
      ["What data type will be returned if the following line of code is run?<blockquote><i>return(5 + 3)</i></blockquote>",
      "float",
      "int",
      "bool",
      "string",
      ...
      ["What data type will be returned by the input() function?",
      "float",
      "int",
      "bool",
      "string",
      ...
      ["What data type will be returned if the following line of code is run?<blockquote><i>return(6 / 2)</i></blockquote>",
      "float",
      "int",
      "bool",
      "string",
      ...
      ["What data type will be returned if the following line of code is run?<blockquote><i>return(10 // 3)</i></blockquote>",
      "float",
      "int",
      "bool",
      "string",
      ...
      ["Which of the followinging is true?",
      "addition precedes subtraction",
      "addition precedes multiplication",
      "multiplication precedes addition",
      "addition precedes division",
      "these statements can not be evaluated",
      "a", "a", "c", "90" ],
      ...
      "addition precedes exponents",
      "these statements can not be evaluated",
      "a", "a", "c", "90" ],

      ["Which of the followinging is NOT true?",
      "exponents precedes multiplication",
      "parenthesis precedes exponents",
      "division precedes addition",
      "addition precedes subtraction",
      "multiplication precedes addition",
      "a", "a", "d", "90" ],

      ["What data type will be returned if the following line of code is run?<blockquote><i>return(2 > 3)</i></blockquote>",
      "float",
      "int",
      "bool",
      "string",
    ...
    ["What will be the output if the following line of code is run?<blockquote><i>print(5 + 5 x 2)</i></blockquote>",
      "15",
      "20",
      "30",
      "27",
      ...
      ["What will be the output if the following line of code is run?<blockquote><i>print(5 - 2)</i></blockquote>",
        "3",
        "3.0",
        "7",
        "10",
        ...
        ["What will be the output if the following line of code is run?<blockquote><i>print(1 ** 2 ** 3)</i></blockquote>",
          "1",
          "6",
          "16",
          "255",
          ...
          ["What will be the output if the following line of code is run?<blockquote><i>print(22 % 5)</i></blockquote>",
            "0",
            "4",
            "5",
            "17",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(10 << 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(1 << 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(3 << 1)</i></blockquote>",
              "2",
              "10",
              "6",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(5 << 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(40 >> 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(4 >> 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(20 >> 1)</i></blockquote>",
              "2",
              "10",
              "5",
              "True",
          ...
          ["What will be the output if the following line of code is run?<blockquote><i>print(20 % 5)</i></blockquote>",
            "0",
            "4",
            "5",
            "15",
          ...
          ["What will be the output if the following line of code is run?<blockquote><i>print(2 ** 2)</i></blockquote>",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(2 ** 2 ** 2)</i></blockquote>",
              "4",
              "6",
              "16",
              "8",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(3 ** 2)</i></blockquote>",
              "27",
              "6",
              "1",
              "9",
        ...
        ["What will be the output if the following line of code is run?<blockquote><i>print(5 - 2.0)</i></blockquote>",
          ...
          ["Right-sided binding means that the followinging expression<blockquote><i>2 ** 3 ** 4</i></blockquote>will be evaluated...",
            "from left to right",
            "from right to left",
            "randomly",
            "starting with the lowest place value",
            "starting with the highest place value",
            "a", "a", "b", "90" ],

            ["Which of the followinging is true about keywords?",
              "cannot be used as a variable name",
              "is another term for a function name",
              "are passed through functions to define a functions parameters",
            ...
            ["Which of the followinging is true about keywords?",
              ...
              "is another term for a variable name",
              "are a type of data structure",
              "are associated with dictionaries",
              "none of these are true",
              "d", "a", "a", "90" ],

            ["Right-sided binding means that which part of followinging expression<blockquote><i>1 ** 2 ** 3 ** 4 ** 5</i></blockquote>will be evaluated first?",
              "1 ** 2",
              "4 ** 5",
              "2 ** 3",
              "3 ** 4",
              ...
              ["According to right-sided binding, in followinging expression<blockquote><i>1 ** 2 ** 3 ** 4 ** 5</i></blockquote>which part will be evaluated last?",
                "1 ** 2",
                "4 ** 5",
                "2 ** 3",
                "3 ** 4",
      ...
      ["What will be the output if the following line of code is run?<blockquote><i>print(5 x 2)</i></blockquote>",
        "3",
        "25",
        "7",
        "10",
          ...
          ["What will be the output if the following line of code is run?<blockquote><i>print(5 ** 2)</i></blockquote>",
            ...
            ["What will be the output if the following line of code is run?<blockquote><i>print(5 / 2)</i></blockquote>",
              ...
              ["What will be the output if the following line of code is run?<blockquote><i>print(5 // 2)</i></blockquote>",
                ...
                ["What will be the output if the following line of code is run?<blockquote><i>print( 1 / 2 + 3 // 3 + 4 ** 2)</i></blockquote>",
                  "17.5",
                  "8",
                  "17",
                  "8.5",
              ...
              ["If we wanted to print Hello World using a single print command, across two lines as shown below, which of the followinging would produce that result?<blockquote><i>Hello<br>World</i></blockquote>",
                "print('Hello &#92;nWorld')",
                "print(Hello &#92;nWorld)",
                "print('Hello &#92;&#92;World')",
                'print("Hello &#92;&#92;World")',
                ...
                ["The &#92;n digraph forces the print() function to...",
                            "overide whatever is in the print arguments and only outputs &#92;n",
                            "stop the execution of the program",
                            "duplicate the character next to the digraph",
                            "break the output line",
                            "repeat whatever value was most recently accessed",
                            "b", "b", "d", "90" ],

              ["What will be the output if the followinging line of code is run?<blockquote><i>print('Hello &#92;nWorld')</i></blockquote>",
                          "Hello<br>World",
                          "'Hello<br>World'",
                          "('Hello &#92;nWorld')",
                          "'Hello &#92;nWorld'",
                          ...
                          ["What will be the output if the followinging line of code is run?<blockquote><i>print('Hello' + 'World')</i></blockquote>",
                                      "Hello World",
                                      "HelloWorld",
                                      "'Hello''World'",
                                      "'Hello+World'",
...
function renderResults(){
  ...
  test2.innerHTML += "<br><br><br><h1>Quiz Complete</h1><br> See results below.<br>";
  document.getElementById('test').style.lineHeight = '1.1';
  test.innerHTML += "<h1>Results for " + userFirstName + "</h1>";
  test.innerHTML += now();
  test.innerHTML += attemptid();
  test.innerHTML += "<br><br>Screenshot & upload your results!<br>";
    test.innerHTML += "<center><table id='render'><tr><td valign='top'><p id='render1'></p><br></td><td align='right'><p id='render2'></p></td></tr></table></center>";
  ...
  render2.innerHTML += "<span>" + totasNames[3] + "</span><span>" + showNum(corrs[3]) + showOf() + showNum(totas[3]) + "</span><br>";

  render1.innerHTML += "<br><br><br><br><br><br><br><h1>Difficulty</h1>"
  render1.innerHTML += "<span>" + showNum(rigos[0]) + showOf() + showNum(rigot[0]) + "</span><span>" + rigosNames[0] + "</span><br>";
  render1.innerHTML += "<span>" + showNum(rigos[1]) + showOf() + showNum(rigot[1]) + "</span><span>" + rigosNames[1] + "</span><br>";
  render1.innerHTML += "<span>" + showNum(rigos[2]) + showOf() + showNum(rigot[2]) + "</span><span>" + rigosNames[2] + "</span><br>";

  test.innerHTML += now();
  test.innerHTML += attemptid();
  if (vs < 500) {
     test2.innerHTML += '<button onclick="location.reload()">Re-test</a>';
  } else if (vs === 500) {
     test2.innerHTML += '<br>No chances remaining. Submit your screenshots. ';
  }
...
function renderQuestion() {
  ...
  test.innerHTML += "<br>Select the best answer:<br><br><br><div id='test3'></div>";
  if (randInt<2) {
        test3.innerHTML += "<label><input type='radio' name='choices' value='b'> "+chB+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='c'> "+chC+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='a'> "+chA+"</label>";
		    test3.innerHTML += "<label><input type='radio' name='choices' value='e'> "+chE+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='d'> "+chD+"</label><br>";
  } else if (randInt<4) {
        test3.innerHTML += "<label><input type='radio' name='choices' value='c'> "+chC+"</label>";
		    test3.innerHTML += "<label><input type='radio' name='choices' value='e'> "+chE+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='d'> "+chD+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='a'> "+chA+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='b'> "+chB+"</label><br>";
  } else if (randInt<6) {
        test3.innerHTML += "<label><input type='radio' name='choices' value='d'> "+chD+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='b'> "+chB+"</label>";
		    test3.innerHTML += "<label><input type='radio' name='choices' value='e'> "+chE+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='c'> "+chC+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='a'> "+chA+"</label><br>";
  } else if (randInt<8) {
        test3.innerHTML += "<label><input type='radio' name='choices' value='a'> "+chA+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='b'> "+chB+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='c'> "+chC+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='d'> "+chD+"</label>";
		    test3.innerHTML += "<label><input type='radio' name='choices' value='e'> "+chE+"</label><br>";
  } else {
		    test3.innerHTML += "<label><input type='radio' name='choices' value='e'> "+chE+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='a'> "+chA+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='d'> "+chD+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='b'> "+chB+"</label>";
        test3.innerHTML += "<label><input type='radio' name='choices' value='c'> "+chC+"</label><br>";
  }
  test3.innerHTML += "<button onclick='checkA()'>Submit Answer</button><br>";
  maxtimelimit= parseInt(questions[posn][9]);
  timelimit = parseInt(questions[posn][9]);
  clearInterval(myVar);
  startTimer();
}

function checkA(){
  test2.innerHTML = "<br><I><font size='-1' color='#dddddd'>The previous question was: </font></I><br>"
  test2.innerHTML += questions[posn][0]
  test2.innerHTML += "<br><br><I><font size='-1' color='#dddddd'>The correct answer was: </font><br></I>"
  if (questions[posn][8] == "a" && timelimit > 0) { test2.innerHTML += questions[posn][1] }
  if (questions[posn][8] == "b" && timelimit > 0) { test2.innerHTML += questions[posn][2] }
  if (questions[posn][8] == "c" && timelimit > 0) { test2.innerHTML += questions[posn][3] }
  if (questions[posn][8] == "d" && timelimit > 0) { test2.innerHTML += questions[posn][4] }
  if (questions[posn][8] == "e" && timelimit > 0) { test2.innerHTML += questions[posn][5] }
...
if (questions[posn][7] == "a" && timelimit > 0) { rigot[0]++; 
} else if (questions[posn][7] == "b" && timelimit > 0) { rigot[1]++; 
} else if (questions[posn][7] == "c" && timelimit > 0) { rigot[2]++; 
}
    
  if (choice == questions[posn][8] && timelimit > 0) { cor++;
     if (questions[posn][6] == "a" && timelimit > 0) { corrs[0]++; }
     else if (questions[posn][6] == "b" && timelimit > 0) { corrs[1]++; }
     else if (questions[posn][6] == "c" && timelimit > 0) { corrs[2]++; }
     else if (questions[posn][6] == "d" && timelimit > 0) { corrs[3]++; }
     else if (questions[posn][6] == "e" && timelimit > 0) { corrs[4]++; }

     if (questions[posn][7] == "a" && timelimit > 0) { rigos[0]++; }
     else if (questions[posn][7] == "b" && timelimit > 0) { rigos[1]++; }
     else if (questions[posn][7] == "c" && timelimit > 0) { rigos[2]++; }}



  pos++;  posn = questionOrder[pos];
  if (pos < ques) { renderQuestion(); } else { renderResults(); }
}
