  ...
  ["Python is an example of:",
    ...
    ["What is the file extension for a Python file?",
      ...
      ["Which of the following files would be a python file?",
        ...
        ["Which of the following is the tool that lets you run your code step-by-step, allowing you to inspect it through each process of your program ",
          ...
          ["What does the acronym IDE stand for?",
            "independent data endpoint",
            "immersive development environment",
            "integrated development endpoint",
        ...
        ["Python is named after...",
          ...
          ["Who is the creator of Python?",
            ...
            ["Which of these is the interactive development and learning environment, designed to help beginners learn Python?",
              "IDE",
              "IDLE",
              "CPython",
              "PyCharm",
            ...
            ["What is IDLE?",
              ...
              "an Interactive Development and Learning Environment, designed to help beginners",
              "a command line tool used for debugging python",
              "a GUI used for debugging python",
              "a library used for generating arrays in python",
              "a", "b", "b", "90" ],
            ...
            ["What is the definition of source code?",
              ...
              ["An interpreter is...",
                "a command line tool used for debugging python",
                "a GUI used for debugging python",
                "a computer program that directly executes instructions line by line without compilation",
              ...
              ["A compiler is...",
                ...
                ["A script could be defined as ...",
                  "a command line tool used for debugging python",
                  "a GUI used for debugging python",
                  "a computer program that directly executes instructions line by line without compilation",
                  "a library used for generating multi-dimensional lists",
                  "A text file that contains instructions which make up a program Python (or other similar languages)",
                  "b", "a", "e", "90" ],

              ["What is a computer program that changes source code into machine code before it can be run?",
                "a translator",
                "an ide",
                "a debugger",
                "an interpreter",
              ...
              ["What is true of compiled code?",
                "the resulting code is high-level",
                "the code is executed by a web browser",
                "it must be run through a virtual machine",
                "both your and the end user much have the compiler installed",
                "it is generally faster than interpretted code",
                "b", "a", "e", "90" ],
                ...
                ["What is true of compiled code?",
                  ...
                  "it must be run through a virtual machine",
                  "both your and the end user much have the compiler installed",
                  "it is machine code that can be executed by the processor",
                  "b", "a", "e", "90" ],
                ...
                ["CPython, the default reference implementation of Python is written...?",
                  ...
                  ["What do you call a command-line interpreter which lets you interact with your OS and execute commands and scripts?",
                    "a translator",
                    "an ide",
                    "a debugger",
                    "a console",
              ...
              ["What is a computer program that directly executes instructions line by line without compilation?",
                "a translator",
                "an ide",
                "a debugger",
                "an interpreter",
        ...
        ["Which version of Python are we using (this is also the most popular version)?",
          ...
          ["Which of the following will let us write a comment in python?",
            ...
            ["Which of the following will let us write a comment in python?",
              ...
              ["What will be the output if the follow line of code is run?<blockquote><i>prit('hello')</i></blockquote>",
							"('hello')",
							"hello",
							"'hello'",
							"the code will produce an error",
              ...
              ["What will be the output if the follow line of code is run?<blockquote><i>prnt('hello' + 'world')</i></blockquote>",
							"('helloworld')",
							"hello world",
							"'hello world'",
							"the code will produce an error",
	...
	["What will be the output if the follow line of code is run?<blockquote><i>print('hello' + 'world')</i></blockquote>",
		...
		["What will be the output if the follow line of code is run?<blockquote><i>print('hello' + ' ' + 'world')</i></blockquote>",
			...
			["What will be the output if the follow line of code is run?<blockquote><i>print('hello' - 'llo')</i></blockquote>",
				...
				["Why will the following line of code produce an error?<blockquote><i>print('hello' - 'llo')</i></blockquote>",
							"print is not a valid instruction in python",
							"the words should not be encapsulated in parenthesis",
							"print is mispelled",
							"you can not use the subtraction operator with text",
							'the words should be encapsulated with double quotes',
							"c", "b", "d", "90" ],
	
					['Why will the following line of code produce an error?<blockquote><i>print"hello"</i></blockquote>',
							"print is not a valid instruction in python",
							"the words should be encapsulated in parenthesis",
							"print is mispelled",
							"you can not use the subtraction operator with text",
							'the words should be encapsulated with double quotes',
							"c", "b", "b", "90" ],
					...
					["Why will the following line of code produce an error?<blockquote><i>prnt('hello')</i></blockquote>",
							"print is not a valid instruction in python",
							"the words should be encapsulated in parenthesis",
							"print is mispelled",
							"you can not use the subtraction operator with text",
	...
	["What does the escape character do?",
							"can be used to ignore a runtime error",
							"escapes out of the current loop or conditional",
							"quits the program",
							"changes the meaning of the character that follows it",
							"changes the meaning of the character that preceeds it",
							"b", "a", "d", "90" ],
