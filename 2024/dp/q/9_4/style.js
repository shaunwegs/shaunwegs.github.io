...
var vs = localStorage.getItem('csmt2_on_load_counter');
var userFirstName = localStorage.getItem('csmt2_userFirstName');
var userLastName = localStorage.getItem('csmt2_userLastName');
...
[
	...
	[
		...
		[
			'What will be the output from the following code snippet? <br><br>int x = 20;<br>int y = 18;<br>if (x > y) {<br>printf("x is greater than y");<br>}',
			...
			[
				'What will be the output from the following code snippet? <br><br>for(int i = 0; i < 3; ++i)<br>{<br>printf("hello ");<br>}',
				"hello hello hello ",
	...
	[
		...
		[
			...
			"hellohellohellohello",
			"hello hello hello hello ",
			"it'll run forever (or until your computer get's angry)",
			"nothing will print",
			"d", "d", "d" ],
...
[
	...
	"a", "a", "a" ],
[
	"The more common term for iteration is",
	"sequence",
	"loops",
	"conditionals",
	"if/else",
	...
	"b", "b", "b" ],
	[
		"The more common term for selection is",
		"sequence",
		"loops",
		"operators",
		"if/else",
		...
		"d", "d", "d" ],
[
	"The JetBrains IDE we can use for C is",
	"PyCharm",
	"IntelliJ",
	"CLion",
	"WebStorm",
...
function renderResults(){
  ...
  $_("test_status").innerHTML = "<h1>DP CS, Sept. 4th Quiz</h1><h2>Year 1<BR>Attempt #" +vs;
...
function renderQuestion() {
  var test = $_("test");
  var ques = 20;
  $_("test_status").innerHTML = "<h1>DP CS Sept. 4th Quiz</h1><h2>- Student: "+userFirstName + " " + userLastName+"<br> - Attempt #"+window.vs +" - Q: "+(pos+1)+"/"+ques+"</h2>";
