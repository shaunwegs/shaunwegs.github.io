...
let quotes_array = [
  ...
  "This is directly to the right of the first block.",
  "Last, we will use the Light Up command.",
  "This will be placed in the third block of the Main Method.",
  "This is directly to the right of the second block.",
  "This will complete the level.",
  "Later, we will use additional commands to complete more complicated levels.",
];
